  ...
  <section class="container mx-auto px-4 text-glotellWhite mt-32" id="about">
    <div class="flex flex-col md:flex-row gap-8 mb-16">
      ...
      <div class="w-full md:w-3/4 rounded-3xl overflow-hidden border-2 p-8">
        ...
        <h3 class="mt-4 font-bold text-sizeLg">Stay in Touch, Stay Credible</h3>
        <p class="mt-2">
        ...
        <h3 class="mt-4 font-bold text-sizeLg">Discreet and Seamless Connectivity</h3>
        <p class="mt-2">
        ...
        <h3 class="mt-4 font-bold text-sizeLg">Multiple Numbers, One Device</h3>
        <p class="mt-2">
        ...
        <h3 class="mt-4 font-bold text-sizeLg">Limitless Freedom, Simplified Communication</h3>
        <p class="mt-2">
    ...
    <div class="flex flex-col md:flex-row gap-8">
      <div class="w-full md:w-3/4 rounded-3xl overflow-hidden border-2 p-8">
        ...
        <h3 class="mt-4 font-bold text-sizeLg">Expert Guidance and Regulatory Compliance</h3>
        <p class="mt-2">
        ...
        <h3 class="mt-4 font-bold text-sizeLg">Comprehensive Service Offerings</h3>
        <p class="mt-2">
